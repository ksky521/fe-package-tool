...
function fromString(css, relativePath, rootPath, cb, MAXSIZE) {
  if (typeof MAXSIZE === 'boolean') {
    MAXSIZE = MAXSIZE;
  }
...
function fromFile(cssFile, root, cb, maxsize) {
